...
// Controleer of er een artikelId is opgegeven
if (isset($_GET['artikelId'])) {
    ...
    if ($artikelData) {
        // Het artikel bestaat, toon het formulier om het artikel bij te werken
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            // Het formulier is ingediend, verwerk de bijgewerkte gegevens
            ...
            // Optioneel: toon een succesbericht of doorverwijzing naar de artikelen.php-pagina
            header("Location: artikelen.php");
            exit();
        }
    } else {
        // Het artikel bestaat niet, toon een foutmelding of doorverwijzing naar de artikelen.php-pagina
        header("Location: artikelen.php");
        exit();
    }
} else {
    // Er is geen artikelId opgegeven, doorverwijzing naar de artikelen.php-pagina
    header("Location: artikelen.php");
    exit();
}
